...
export default function HomeScreen({ navigation }: HomeProps) {
    ...
    return (
        <ImageBackground source={backgroundImage} resizeMode="cover" style={styles.background} imageStyle={{ opacity: 0.5 }}>
            <View style={styles.container}>
                ...
                <TouchableOpacity
                    ...
                    onPress={() => {
                        handlePress();
                        navigation.navigate('BeforeSixMonths')
                    }}
                >
                ...
                <TouchableOpacity
                    style={styles.button}
                    onPress={() => {
                        handlePress(); navigation.navigate('SixToEightMonths')
                    }}
                >
                ...
                <TouchableOpacity
                    style={styles.button}
                    onPress={() => {
                        handlePress(); navigation.navigate('EightToTenMonths')
                    }}
                >
                ...
                <TouchableOpacity
                    style={styles.button}
                    onPress={() => {
                        handlePress(); navigation.navigate('TenToTwelveMonths')
                    }}
                >
                ...
                <TouchableOpacity
                    style={styles.button}
                    onPress={() => {
                        handlePress(); navigation.navigate('OverTwelveMonths')
                    }}
                >
                    <Text style={styles.buttonText}>Older than 12 months</Text>
                </TouchableOpacity>
            </View>
        </ImageBackground >
    );
